<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=KIKO&fontSize=80&fontAlignY=35&animation=twinkling&fontColor=white" />
</div>

<h1 align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=30&pause=1000&color=00F7B5&center=true&vCenter=true&width=600&lines=Full-Stack+Developer;UI%2FUX+Enthusiast;Creative+Problem+Solver;Open+Source+Contributor" alt="Typing SVG" />
</h1>
...
<table align="center">
  <tr>
    ...
    <td width="70%">
      <div style="background: linear-gradient(145deg, #0d1117 0%, #1a2433 100%); padding: 25px; border-radius: 20px; border-left: 5px solid #00F7B5;">
        <h3>🚀 About Me</h3>
        <p style="font-size: 16px; line-height: 1.8;">
          I'm a passionate developer with a love for creating elegant solutions to complex problems. 
          I believe in clean code, continuous learning, and building things that make a difference.
        </p>
        <details>
          <summary>📖 More about me</summary>
          <ul style="margin-top: 15px;">
            <li>🎯 Currently learning: Advanced Python & Cloud Architecture</li>
            <li>🎮 Hobbies: Gaming, Reading Tech Blogs, Open Source</li>
...
<!-- Footer Wave -->
<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=150&section=footer&fontSize=80" />
</div>
